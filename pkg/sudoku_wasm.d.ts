 ...
 */
export function solve(digits: Uint8Array): Uint8Array;

/**
 * Return true if non-zero givens do not conflict.
 */
export function validate_givens(digits: Uint8Array): boolean;
...
export interface InitOutput {
    ...
    readonly validate_givens: (a: number, b: number) => [number, number, number];
    readonly init: () => void;
